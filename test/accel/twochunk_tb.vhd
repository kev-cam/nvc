...
entity twochunk_tb is
  generic (N : integer := 1000000);
end entity;

architecture sim of twochunk_tb is
...
begin
  dut : entity work.twochunk
    port map (clk => clk, seed => seed, result => result);

  clk <= not clk after 5 ns when running else '0';

  -- vary the seed and accumulate the pipeline output each cycle
  process (clk) is
  begin
