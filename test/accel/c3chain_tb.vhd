...
entity c3chain_tb is generic (N : integer := 100000); end entity;
architecture sim of c3chain_tb is
...
begin
  dut : entity work.c3chain port map (clk => clk, seed => seed, result => result);
