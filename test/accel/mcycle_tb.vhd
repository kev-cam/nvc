...
entity mcycle_tb is generic (N : integer := 100000); end entity;
architecture sim of mcycle_tb is
...
begin
  dut : entity work.mcycle port map (clk => clk, seed => seed, result => result);
