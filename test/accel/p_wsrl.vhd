...
entity p_wsrl is port (clk, rst_l : in std_logic; y : out std_logic_vector(31 downto 0)); end entity;
architecture rtl of p_wsrl is
  ...
  process (clk) is variable mix : unsigned(31 downto 0); variable wtmp : unsigned(99 downto 0); begin
    if rising_edge(clk) then
      if rst_l = '0' then acc <= (others=>'0'); wacc<=(others=>'0'); shamt<=0;
        ...
        wtmp := wacc srl shamt; mix := wtmp(31 downto 0);
