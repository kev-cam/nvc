...
entity p_nsrl_bounded_tb is generic (N : integer := 200000); end entity;
architecture sim of p_nsrl_bounded_tb is
  signal clk, rst_l : std_logic := '0';
  signal y : std_logic_vector(31 downto 0);
  signal chk : unsigned(31 downto 0) := (others => '0');
  signal running : boolean := true;
begin
  dut : entity work.p_nsrl_bounded port map (clk=>clk, rst_l=>rst_l, y=>y);
