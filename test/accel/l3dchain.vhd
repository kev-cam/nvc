...
architecture rtl of l3dchain is
  signal a2b, b2a : logic3d_vector(31 downto 0);
  signal src : logic3d_vector(31 downto 0) := (7 downto 0 => L3D_1, others => L3D_0);
begin
  ua : entity work.lh_a port map (clk => clk, ain => src, aout => a2b);   -- ring BROKEN
  ub : entity work.lh_b port map (clk => clk, bin => a2b, bout => b2a);
