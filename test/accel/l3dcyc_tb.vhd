-- Testbench for l3dcyc.  The checksum folds the RAW logic3d codes (0..7), not a
...
entity l3dcyc_tb is end entity;

architecture tb of l3dcyc_tb is
...
begin
  dut : entity work.l3dcyc port map (clk => clk, seed => seed, result => result);
