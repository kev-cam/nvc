...
entity cchain_tb is generic (N : integer := 100000); end entity;
architecture sim of cchain_tb is
...
begin
  dut : entity work.cchain port map (clk => clk, seed => seed, result => result);
