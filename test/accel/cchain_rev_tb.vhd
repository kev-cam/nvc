...
entity cchain_rev_tb is generic (N : integer := 100000); end entity;
architecture sim of cchain_rev_tb is
...
begin
  dut : entity work.cchain_rev port map (clk => clk, seed => seed, result => result);
