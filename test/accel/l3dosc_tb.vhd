-- Testbench for l3dosc.  The checksum folds the RAW logic3d codes (0..7), not a
...
entity l3dosc_tb is end entity;

architecture tb of l3dosc_tb is
...
begin
  dut : entity work.l3dosc port map (clk => clk, seed => seed, result => result);
