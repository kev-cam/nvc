...
{
   mir_build_2(mu, MIR_OP_ENABLE_LAST_VALUE, MIR_NULL_TYPE, MIR_NULL_STAMP,
               on, count);
...
mir_value_t mir_build_cast(mir_unit_t *mu, mir_type_t type, mir_value_t value)
{
   ...
   static const mir_class_t allowed[][2] = {
      ...
      { MIR_TYPE_VEC2,   MIR_TYPE_REAL    },
      { MIR_TYPE_VEC4,   MIR_TYPE_REAL    },
   };
